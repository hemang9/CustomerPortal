CREATE TABLE [staging].[IncidentsPartShipmentTracking]
(
...
GO
ALTER TABLE [staging].[IncidentsPartShipmentTracking] ADD CONSTRAINT [PK_IncidentsPartShipmentTracking] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
